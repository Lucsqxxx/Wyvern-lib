...
ORDER = [
    ...
    ("Core/Flags.lua", "Core.Flags"),
    ("Components/Switch.lua", "Components.Switch"),
    ("Components/RadioGroup.lua", "Components.RadioGroup"),
    ("Components/Table.lua", "Components.Table"),
    ("Components/Layout.lua", "Components.Layout"),
    ("Core/ThemeRegistry.lua", "Core.ThemeRegistry"),
    ...
    ("Components/Feature.lua", "Components.Feature"),
    ("Components/ProgressBar.lua", "Components.ProgressBar"),
